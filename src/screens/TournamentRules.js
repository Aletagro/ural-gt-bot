...
const TournamentRules = () => {
    ...
    return <div id='column' className='Chapter'>
        ...
        <p id={Styles.text}>Как подать ростер и валидировать армию: Ростер загружается через это приложение. Обязательная фотовалидация листов через ВК личным сообщением: <p id={Styles.orgLink} onClick={handlleClickOrgLink}>https://vk.com/istmus</p>. Крайний срок подачи листов и фото армий 23:59 8 сентября. </p>
