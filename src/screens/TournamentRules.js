...
const TournamentRules = () => {
    ...
    return <div id='column' className='Chapter'>
        ...
        <p id={Styles.text}>Как подать ростер и валидировать армию: Ростер загружается через это приложение. Обязательная фотовалидация листов также через это приложение. Крайний срок подачи листов и фото армий 23:59 9 марта 2006. </p>
